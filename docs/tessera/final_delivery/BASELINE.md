...
- Live Web: `https://tessera.hont.ro`, schema v15, image digest `sha256:58223131…c10e91`.
- Live RM: two v0.5.38 deployments at digest `sha256:b51b7f13…35217a`, exact-action authorization and MCP SDK 1.28.1; account B awaits independent authorization.
