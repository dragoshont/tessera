  ...
  return (
    <SafeAreaView style={[styles.page, { backgroundColor: palette.background }]}>
      <View style={styles.content}>
        <Mark size={54} />
        <View style={styles.heading}><Text style={[styles.name, { color: palette.text }]}>Tessera</Text><Text style={[sharedStyles.body, { color: palette.muted, textAlign: 'center' }]}>Your private assistant, connected to one trusted home server.</Text></View>
...
const styles = StyleSheet.create({
  page: { flex: 1 },
  content: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: Space.xl, gap: Space.xl },
